import { bootstrap } from "https://deno.land/x/cargo@0.1.18/mod.ts";
import { Get, UrlParams } from "https://deno.land/x/cargo@0.1.18/http/mod.ts";
import { timeToResponse } from "https://deno.land/x/cargo@0.1.18/middleware/mod.ts";
