import { bootstrap } from "https://deno.land/x/cargo@0.1.27/mod.ts";
import { Get, UrlParams } from "https://deno.land/x/cargo@0.1.27/http/mod.ts";
import { timeToResponse } from "https://deno.land/x/cargo@0.1.27/middleware/mod.ts";
