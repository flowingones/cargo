import { bootstrap } from "https://deno.land/x/cargo@0.1.12/mod.ts";
import { Get, UrlParams } from "https://deno.land/x/cargo@0.1.12/http/mod.ts";
import { timeToResponse } from "https://deno.land/x/cargo@0.1.12/middleware/mod.ts";
